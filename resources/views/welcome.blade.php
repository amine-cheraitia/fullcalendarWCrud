    ...
    <div
        ...
        <div class="content">
            ...
            <div class="container">
                ...
                <div class="mb-5">
                    <button class="btn btn-dark" id="addEventButton">Add Event</button>
                </div>
                @endif
                @endauth
                <div id="calendar"></div>
        ...
        <div id="dialog">
            <div id="dialog-body">
                <form id="dayClick" method="POST" action="{{route('eventStore')}}">
                    ...
                    <div id="btnContainer" class="form-group d-flex justify-content-center align-content-center">
        ...
        {{-- <script src="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.10.2/locale/fr.min.js"
            integrity="sha512-vz2hAYjYuxwqHQAgHPZvry+DTuwemFT/aBIDmgE0cnmYENu/+t8c3u/nX2Ont6e+3m+W6FEKxN1granjgGfr1Q=="
